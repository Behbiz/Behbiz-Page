        ...
        {isDesktopOrLaptop ? (
          ...
          >
            ...
            <ul className={styles.socials}>
              ...
              <li>
                <a
                  href="https://www.instagram.com/isabelscastro/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <BsInstagram />
              ...
              <li>
                <a
                  href="https://www.linkedin.com/in/isabel-santos-castro-/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <ImLinkedin2 />
            ...
            <div className={styles.btns}>
              <button value="br" onClick={handleOnclick} />
          ...
          <nav open={open} location={location.pathname} className={`nav ${styles.nav}`}>
            ...
            <div className={styles.btns}>
              <button value="br" onClick={handleOnclick}></button>
